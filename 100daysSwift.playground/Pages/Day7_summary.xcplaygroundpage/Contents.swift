...
* When passing a closure as a function parameter, you don't need to write out the types inside your closure if Swift can figure *  out.
...
* You can make vour own functions that accept functions as parameters
*/
